...
(function() {
  ...
  Translator = (function() {
    ...
    Translator.prototype.loadCategory = function(path, name) {
      var categoryName, data, e, filePath;
      ...
      if (typeof this.data[categoryName] === 'undefined') {
        ...
        try {
          if (this.cache === null) {
            this.data[categoryName] = this.loadFromFile(filePath);
          } else {
            data = this.cache.load(this.language + ':' + categoryName);
            if (data === null) {
              data = this.cache.save(this.language + ':' + categoryName, this.loadFromFile(filePath), {
                files: [filePath + '.json']
              });
            }
